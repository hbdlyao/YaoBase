...
protected:
	...
	void doLoad_xbMonitor_Root();
	void doLoad_xbMonitor_Tree(CxbDevMonitor * vParent, int vIndex);
	...
	void doSave_xbMonitor_Root();
	void doSave_xbMonitor_Tree(CxbDevMonitor * vParent, int vIndex);
	virtual void doLoad_Data();
	virtual void doSave_Data();
