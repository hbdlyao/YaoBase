...
/**
 * 南方电网主回路及谐波计算软件* 改动对象:  doRun 改动者:    崔康生 改动类型:  修改 改动内容:  1.pmcProfile-
 * >Clear()改为pmcProfile->ClearSingle()，仅Clear pmcProfile自身的变量，保留其中的Order和Result
 * 改动时间:  2017/04/13
 */
