...
void CmcCalConvertor::Prepare()
{
	...
	//额定值
	pmcProfile->pmcStaDataN[vK].nValvor12 = vDev->GetValvor12Count();
	...
	pmcProfile->pmcStaDataN[vK].Ang = vDev->GetAlpha_gamaN();
	pmcProfile->pmcStaDataN[vK].AngMax = vDev->GetAngleMax();
	pmcProfile->pmcStaDataN[vK].AngMin = vDev->GetAngleMin();
	...
	pmcProfile->pmcStaData[vK].Ang = vDev->GetAlhpa_gama();
	pmcProfile->pmcStaData[vK].AngMax = vDev->GetAngleMax();
	pmcProfile->pmcStaData[vK].AngMin = vDev->GetAngleMin();
